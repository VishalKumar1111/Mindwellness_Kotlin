...
import com.rlogixmindwellness.Colour
import com.rlogixmindwellness.R
import com.rlogixmindwellness.StressFolder.Stress
import com.rlogixmindwellness.Treatment

class Yoga : AppCompatActivity() {
    /*   private   val imageTitle = mutableListOf(
        "MindWellness","MindWellness","MindWellness","MindWellness","MindWellness","MindWellness")
    ...
    private var topicimageList = mutableListOf(R.drawable.helpapp, R.drawable.twelve,
        R.drawable.yog,
...
*/
  ...
  /*      val mainImage: ImageView = findViewById(R.id.main_image)
     // val container = findViewById<RelativeLayout>(R.id.relative_lay)
        ...
        title.setOnClickListener { startActivity(Intent(this@Yoga, Stress::class.java)) }
        description.text =
            "Benefits Of Yoga \n 1- Relief from depression and anxiety.\n2- Reduce the effects of PTSD and similar conditions\n 3- Boost concentration, focus, and memory \n  4- Improve your mood \n 5- Keep your brain young\n"
            ...
            override fun onItemChanged(position: Int) {
                ...
                if (position == 0) {
                    ...
                    title.setOnClickListener {
                        startActivity(Intent(this@Yoga, Stress::class.java))
                    }
                    description.text = descTitle[0]
                    mainImage.setImageResource(topicimageList[0])
                    mainImage.setOnClickListener {
                        startActivity(
                            Intent(this@Yoga,Treatment::class.java)
                        )
                    }
                ...
                if (position == 1) {
                    ...
                    title.setOnClickListener {
                        startActivity(
                            Intent(this@Yoga, Stress::class.java)
                        )
                    }
                    description.text = descTitle[1]
                    mainImage.setImageResource(topicimageList[1])
                    mainImage.setOnClickListener {
                        startActivity(Intent(this@Yoga, Treatment::class.java))
                    }
        ...
        imageSlider.setItemClickListener(object : ItemClickListener {
            ...
            override fun onItemSelected(position: Int) {
                if (position == 1) {
                    ...
                    val intent = Intent(this@Yoga, Stress::class.java)
                ...
                if (position==3){
                    startActivity(Intent(this@Yoga,Yoga::class.java))
                }
